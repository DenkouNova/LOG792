...
DROP TABLE image_extract_archive;
DROP TABLE image_extract_condition_links;
DROP TABLE image_extract_ccg;
DROP TABLE image_extract_cond_cat_dictionary;
DROP TABLE image_extract_conditions;
DROP TABLE image_extract_condition_dictionary;
DROP TABLE image_extract_condition_set;
DROP TABLE image_extract;
...
CREATE TABLE 'image_extract_archive' (
  'image_extract_id' INTEGER,
  'archive_naming' STRING,
  'archive_type' STRING CHECK(archive_type IN ('zip', 'tar', 'tar.gz')),
  PRIMARY KEY(image_extract_id),
  FOREIGN KEY(image_extract_id) REFERENCES image_extract(image_extract_id)
);
